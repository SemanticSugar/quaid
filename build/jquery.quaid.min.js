...
h.handleApplicationErrors.call(this,f)},e=a.success||function(){};a.success=function(f,i){f&&!f.status&&!f.errors&&b.log('Hey, you need a "success" or "errors" param on the response data!');f.debug&&h.DEBUG&&h.DEBUG.addRequest(f.debug);f&&f.status=="success"?e.call(this,f,i):d(f)};var g=a.error||function(){};a.error=function(f,i,l){if(f.status>=500){var n=null;try{n=jQuery.httpData(f,a.dataType,a)}catch(o){b.warn("ERROR: Failed to parse error data from the server. Is your response in",a.dataType,
"?","Error:",o)}a.applicationError.call(this,"servererror",f.status);h.handleServerError.call(this,n,f,i,l)}else if(f.status>=400)try{n=jQuery.httpData(f,a.dataType,a);d(n)}catch(m){a.applicationError.call(this,"parsererror",m)}else{n="[Unknown]";try{n=f.responseText||f.responseXML}catch(p){}var j="[Unknown Error]";if(l)j=l.number+": "+l.description;b.log("$.ajax Error ",j,", http status: ",f.status,":",i,"; original",n)}g.call(this,f,i,l)}}return b.ajaxOriginal(a)};h.handleServerError=function(){alert("Oops. An error occurred. Our team has been notified!")};
