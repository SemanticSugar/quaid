...
b.fn[g]=function(m){var n=[];this.each(function(){var j=b(this),q=j.data(g);if(!q)if(b[b.CLASS_NAMESPACE][g]){q=new b[b.CLASS_NAMESPACE][g](j,m);j.data(g,q);q.TYPE=g}else b.log("Cannot find $."+b.CLASS_NAMESPACE+"."+g+"!");n.push(q)});if(n.length==1)return n[0];if(!n.length)return null;return n}}var l=this.prototype;a=true;var o=new this;a=false;for(var p in i)o[p]=typeof i[p]=="function"&&typeof l[p]=="function"&&h.test(i[p])?function(m,n,j){return function(){var q=this._super,r=this._class;this._super=
l[m];this._class=j;var s=n.apply(this,arguments);this._super=q;this._class=r;return s}}(p,i[p],e):i[p];f&&b.extend(e,f);e.prototype=o;e.constructor=e;e.extend=arguments.callee;if(g)b[b.CLASS_NAMESPACE][g]=e;return e}})()})(jQuery);
...
a;var e=a.split(".");d=e[0];var g=null;if(e.length>1)g=e[1];e=a[0]=="-";d=d.replace("-","");var f="";d=d.split("").reverse();for(var i=0;i<d.length;i++){if(i!=0&&i%3==0)f=","+f;f=d[i]+f}if(g)f+="."+g;if(e)f="-"+f;return f},parseDate:function(a,c){if(!a)return null;if(a.constructor==Date||b.isNumber(a))return new Date(a);if(!b.isString(a)||!c)return null;for(var d=a.split(/\W+/),e=c.split(/\W+/),g,f,i,l,o,p=new Date,m=0;m<d.length;m++)switch(e[m]){case "d":case "e":g=parseInt(d[m],10);break;case "m":f=
parseInt(d[m],10)-1;break;case "Y":case "y":i=parseInt(d[m],10);i+=i>100?0:i<29?2E3:1900;break;case "H":case "I":case "k":case "l":l=parseInt(d[m],10);break;case "P":case "p":if(/pm/i.test(d[m])&&l<12)l+=12;else if(/am/i.test(d[m])&&l>=12)l-=12;break;case "M":o=parseInt(d[m],10)}return new Date(i===undefined?p.getFullYear():i,f===undefined?p.getMonth():f,g===undefined?p.getDate():g,l===undefined?0:l,o===undefined?0:o,0)},formatDate:function(a,c){var d=a.getMonth(),e=a.getDate(),g=a.getFullYear(),
f=a.getDay(),i=a.getHours(),l=i>=12,o=l?i-12:i;if(o==0)o=12;for(var p=a.getMinutes(),m=a.getSeconds(),n=c.split(""),j,q=0;q<n.length;q++){j=n[q];switch(n[q]){case "a":j=h.daysShort[f];break;case "A":j=h.days[f];break;case "b":j=h.monthsShort[d];break;case "B":j=h.months[d];break;case "C":j=1+Math.floor(g/100);break;case "d":j=b.zeroPad(e,2);break;case "e":j=e;break;case "H":j=b.zeroPad(i,2);break;case "I":j=b.zeroPad(o,2);break;case "j":j=new Date(a.getFullYear(),a.getMonth(),a.getDate(),0,0,0);var r=
new Date(a.getFullYear(),0,0,0,0,0);j=b.zeroPad(Math.floor((j-r)/864E5),3);break;case "k":j=i;break;case "l":j=o;break;case "m":j=b.zeroPad(1+d,2);break;case "M":j=b.zeroPad(p,2);break;case "p":j=l?"pm":"am";break;case "P":j=l?"PM":"AM";break;case "s":j=Math.floor(a.getTime()/1E3);break;case "S":j=b.zeroPad(m,2);break;case "u":j=f+1;break;case "w":j=f;break;case "y":j=(""+g).substr(2,2);break;case "Y":j=g}n[q]=j}return n.join("")},extendUrl:function(a,c){var d=a.indexOf("?"),e=a,g="";if(d>-1){e=a.substring(0,
...
"")+"/>"}}})(jQuery);
(function(b){var h=b[b.QUAID];b.ajaxOriginal=b.ajax;b.ajax=function(a){if(a.dataType&&a.dataType=="json"){var c=function(){};if(!b.isFunction(a.applicationError))a.applicationError=c;var d=function(f){for(var i={general:[],field:[]},l=0;f.errors&&l<f.errors.length;l++)"field"in f.errors[l]&&f.errors[l].field?i.field.push(f.errors[l]):i.general.push(f.errors[l]);i.field.length>0&&h.asyncErrors.add(i.field);a.applicationError.call(this,"applicationerror",i)},e=a.success||function(){};a.success=function(f,
i){f&&!f.status&&!f.errors&&b.log('Hey, you need a "success" or "errors" param on the response data!');f.debug&&h.DEBUG&&h.DEBUG.addRequest(f.debug);f&&f.status=="success"?e.call(this,f,i):d(f)};var g=a.error||function(){};a.error=function(f,i,l){if(f.status>=500){a.applicationError.call(this,"servererror",f.status);h.handleServerError.call(this,f,i,l)}else if(f.status>=400){b.log("SERVER ERROR",this.url,"; http status:",f.status+":"+i);try{var o=jQuery.httpData(f,a.dataType,a);d(o)}catch(p){a.applicationError.call(this,
"parsererror",p)}}else{o="[Unknown]";try{o=f.responseText||f.responseXML}catch(m){}var n="[Unknown Error]";if(l)n=l.number+": "+l.description;b.log("$.ajax Error ",n,", http status: ",f.status,":",i,"; original",o)}g.call(this,f,i,l)}}return b.ajaxOriginal(a)};h.handleServerError=function(){alert("Oops. An error occurred. Our team has been notified!")};h.asyncErrors={errors:{},add:function(a){h.asyncErrors.clear();if(a){for(var c=null,d=0;d<a.length;d++){var e=b('[name="'+a[d].field+'"]:visible');
if(e.length){if(!c||c.length==0)c=e.parents("form");h.asyncErrors.errors[a[d].field]={message:a[d].message,val:e.val()}}}c&&b.fn.valid&&c.each(function(){b(this).valid()})}},clear:function(){h.asyncErrors.errors={}}};if(b.validator&&b.fn.validate){b.validator.addMethod("asyncError",function(a,c,d){if(!d)return true;a=b(c).val();var e="";if(c.name in h.asyncErrors.errors)e=h.asyncErrors.errors[c.name].val||"";if(d instanceof Object&&d.connect&&d.display){a+=b('[name="'+d.connect+'"]').val();if(d.connect in
h.asyncErrors.errors)e+=h.asyncErrors.errors[d.connect].val||""}else if(d instanceof Object&&d.connect&&!d.display){this.check(b('[name="'+d.connect+'"]'));return true}fail=c.name in h.asyncErrors.errors&&a==e;return!fail},function(a,c){return h.asyncErrors.errors[c.name].message});h.defaultValidationOptions={};h.getValidationOptions=function(a){function c(d){if(typeof d=="string"){var e={};b.each(d.split(/\s/),function(){e[this]=true});d=e}return d}a=b.extend({},h.defaultValidationOptions,a);if(a.rules)for(k in a.rules){a.rules[k]=
...
Math.max(0,this.loadingCount-1);this.loadingCount==0&&this._hide()}});h.AsyncLoader=h.Loader.extend("AsyncLoader",{defaults:{ajaxOptions:{type:"POST",dataType:"json"},onPostLoad:null}},{init:function(a,c){this._super(a,b.extend(true,{},this._class.defaults,c))},_onPostLoad:function(a,c){b.isFunction(this.settings.onPostLoad)&&this.settings.onPostLoad.call(self,a,c)},load:function(a,c,d,e){function g(i,l){return function(){b.isFunction(l)&&l.apply(this,arguments);f.stopLoading();f._onPostLoad.call(f,
...
c){this._super(a,b.extend({},this._class.defaults,c));this.currentRequest=null;this.lastParams={}},_onPostLoad:function(a,c){b.log(this._super);this.currentRequest=null;this._super(a,c)},load:function(a){this.lastParams=a||this.lastParams;if((a=this._super(this.settings.url,this.lastParams,this.settings.onSuccess,this.settings.onFail))&&this.currentRequest){this.currentRequest.abort();this.stopLoading()}this.currentRequest=a}})})(jQuery);
